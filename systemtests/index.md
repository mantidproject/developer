...
Summary
=======
* Job    : [Master Pipeline](http://builds.mantidproject.org/view/Master%20Pipeline/)2017-11-28
* Labels : osx, rhel7, ubuntu, ubuntu-16.04, win7
* Failed : 4(6 unique)
* Skipped: 22(32 unique)
* Total  : 2055
(= 411 * 5)
...
|---------------------------|-----|-------|--------|--------------|------|
| CreateVanadiumAllTest     |     |       |        |       x      |      | 
| CreateVanadiumGroupsTest  |     |       |        |       x      |      | 
| CreateVanadiumModsTest    |     |       |        |       x      |      | 
| CreateVanadiumTest        |     |       |        |              |   x  | 
| CreateVanadiumTransTest   |     |       |        |       x      |      | 
| FocusTest                 |     |       |        |              |   x  | 
