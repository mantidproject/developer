...
* Job    : [master_systemtests](http://builds.mantidproject.org/job/master_systemtests/) 2014-12-02 [#248](http://builds.mantidproject.org/job/master_systemtests/248/)
* Labels : osx-10.8, rhel6, ubuntu-14.04
* Failed : 505 (248 unique)
* Skipped: 33 (33 unique)
* Total  : 756 (= 252 * 3)
...
|----------------------------------------------------------|----------|-------|--------------|
| POLDIAutoCorrelationTest                                 |     x    |   x   |       x      |
| ARCSReductionTest                                        |          |   x   |       x      |
| AbsRunFeederChemicalFormulaTest                          |          |   x   |       x      |
| AbsRunFeederDefaultBeamWidthTest                         |          |   x   |       x      |
| AbsRunFeederTest                                         |          |   x   |       x      |
| Algorithms                                               |          |   x   |       x      |
| BASISAutoReductionTest                                   |          |   x   |       x      |
| BuildSQWTest                                             |          |   x   |       x      |
| CNCSReductionTest                                        |          |   x   |       x      |
...
| LOQReductionOnLoadedWorkspaceMustProduceTheSameResult_1  |          |   x   |       x      |
...
| SANS2DGUISearchCentre                                    |          |   x   |       x      |
| SANS2DLimitEventsTime                                    |          |   x   |       x      |
| SANS2DMinimalBatchReduction                              |          |   x   |       x      |
| SANS2DMinimalBatchReductionSliced                        |          |   x   |       x      |
| SANS2DMinimalSingleReduction                             |          |   x   |       x      |
| SANS2DMinimalSingleReductionSliced                       |          |   x   |       x      |
| SANS2DMultiPeriodAddFiles                                |          |   x   |       x      |
| SANS2DMultiPeriodBatch                                   |          |   x   |       x      |
| SANS2DMultiPeriodSingle                                  |          |   x   |       x      |
| SANS2DNewSettingsCarriedAcrossInBatchMode                |          |   x   |       x      |
| SANS2DReductionGUIAddedFiles                             |          |   x   |       x      |
...
| VulcanSeqRefineProfileFromScratch                        |          |   x   |       x      |
