...
* Job    : [master_systemtests](http://builds.mantidproject.org/job/master_systemtests/) 2014-10-17 [#207](http://builds.mantidproject.org/job/master_systemtests/207/)
...
|--------------------|----------|-------|--------------|------|
| ARCSReductionTest  |     x    |   x   |       x      |   x  |
| CNCSReductionTest  |     x    |   x   |       x      |   x  |
